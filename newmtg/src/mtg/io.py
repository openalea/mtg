...
def mtg2axialtree(g, scales, parameters=None, axial_tree=None):
    """
    Create a MTG from an AxialTree with scales.
    :Parameters:
...
def mtg2lpy(g, lsystem, axial_tree=None):
    ...
    :Parameters:
      ...
      - `lsystem`: A lsystem object containin various information.
    ...
    return mtg2axialtree(g, scales, parameters, axial_tree)
